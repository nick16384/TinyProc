...
#SECTION (__attribute relocatable = false) (__attribute loadaddress = 0x00000100) .data
...
block params_helloworld_call
{
    ...
    pointer hello_world
    ; immediate length_bytes: hello_world
    immediate length_words: hello_world
}

#SECTION .text
_start:
    load  *(hello_world + 0), r0
    store r0, CON:0
    load  *(hello_world + 1), r0
    store r0, CON:1
    ; Syntactic sugar: var[x] = *var + x
    load  *(hello_world + 2), r0
    store r0, CON:2
    load  *(hello_world + 3), r0
    store r0, CON:3
    ...
    load  hello_world, r7          ; Load pointer to the data to be printed
    load  hello_world_words, r8    ; Load the number of words to be printed
