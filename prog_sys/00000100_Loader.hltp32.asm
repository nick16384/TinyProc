...
equ asmheader_offset_version 0 ; The version attribute is technically unnecessary, but is kept for clarity.
equ asmheader_offset_entrypoint 1
equ asmheader_offset_data_addr 2
equ asmheader_offset_data_size 3
equ asmheader_offset_text_addr 4
equ asmheader_offset_text_size 5
equ asmheader_size 8
equ reloc_default_load_address 0x10000000
equ int_vector_reset 0x0
equ sp_base_address 0x00020000

#SECTION (__entry__ = _start) (__adrmodeimplicit__ = relative) .text
    ...
    _start:
        int int_vector_reset ; FIXME: Fix loader for new asm header
    ...
    textIsFixed:
        ...
        call  copySection
        call  clearRegisters
        call  [abs unloaded_program_source + asmheader_offset_text_addr] ; Start the actual program
        jmp   programReturned
